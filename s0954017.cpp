...
void merge(int i,int j,int k,int middle,int right,int counts)
{
...
void findrank(int left, int right) 
{
	...
	merge(i, j, k, middle, right, counts);
...
int main()
{
    ...
    cout<<"total:"<<" "<<num<<endl;
    cout<<"max:"<<" "<<maxrank<<endl;
    cout<<"min:"<<" "<<minrank<<endl;
    cout<<"avg:"<<" ";printf("%.2f",(float)average/num);
